<?php 
class My_Form_Decorators_Fpassinput extends Zend_Form_Decorator_Abstract 
{
	
	protected $_label = '<label for="%s">%s</label>';
	protected $_format = '   <input type="password" id="%s" css:id="%s" name="%s" placeholder="%s" value="%s">';
