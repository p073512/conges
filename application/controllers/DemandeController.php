...
class DemandeController extends Zend_Controller_Action
{
	...
	public function indexAction()
	{
		...
		$this->view->demandeArray = $paginator;
	...
	public function createAction()
	{
		...
		$form = new Default_Form_Demande();
		//indique l'action qui va traiter le formulaire
		$form->setAction($this->view->url(array('controller' => 'demande', 'action' => 'create'), 'default', true));
		$form->submit->setLabel('Soumettre');
		$this->view->form = $form;
		$this->view->title = "Créer une demande";
	...
	public function editAction()
	{
		...
		//indique l'action qui va traiter le formulaire
		$form->setAction($this->view->url(array('controller' => 'demande', 'action' => 'edit'), 'default', true));
