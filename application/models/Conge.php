...
class Default_Model_Conge
{
	...
	//gettors and settors d'acc� aux variables//
	...
	// r�cup�re les cong� sur une p�riode donn�e.
   ...
   public function conges_existant($id_personne,$date_debut,$date_fin,$flag) 
	...
	public function joursOuvresDuMois($debut_mois,$fin_mois)
	{
	    	...
	    	$tableau_jours_feries = array(); // Tableau des jours feri�
	    	...
	    	$difference_annees = date('Y', $date_fin) - date('Y', $date_debut);
			  ...
			  //print_r($tableau_jours_feries);
	  		  $nb_jours_ouvres = 0;
				    ...
				    {
				    // Si le jour suivant n'est ni un dimanche (0) ou un samedi (6), ni un jour f�ri�, on incr�mente les jours ouvr�
   ...
   /** 
	 ...
	 *  
	 *  @return array() de string des jours f�ri�s dans cette periode 
	 *  
   ...
   /** 
     ...
     *         a travers l'appel � la fonction   outils->calculer_jours($date_debut,$date_fin,$maroc)
     *         et enregistre le nombre de jours calcul�s dans l'objet cong� via le setter setNombreJours()
	 * 
	...
	public function calcul_periode_conge($date_debut,$date_fin)
	{
	        ...
	        $annee = (string)date('Y', $date_depart);              // anne�
	        $maroc = false;                                        // France 

	        // mettre les jours f�ri� maroc dans session TEST 
	        ...
	        // enregistrement du nombre de jours dans l'objet cong� via le setter 
	        $this->setNombre_jours($nbj);                                  
	}////////////////////////////////////////////////////////////////////////////////////////////////////////////////

	/**
	 * 
	 * Fonction retournant la somme des jours congé d'une ressouce 
	 * sur une période donnée ...
	 * @param string/int $idRessource
	 * @param string/int $anneeReference
	...
	{
		return $this->getMapper()->somme_conges($idRessource,$anneeReference,$dateDebut,$dateFin,$ferme);
	}
