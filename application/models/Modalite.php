...
class Default_Model_Modalite
{
	...
	//le mapper va nous fournir les méthodes pour interagir avec notre table (objet de type Default_Model_ModaliteMapper)
	protected $_mapper;
	...
	public function getMapper()
	{
		...
		if(null == $this->_mapper){
			$this->setMapper(new Default_Model_ModaliteMapper());
		}
