...
class Default_Model_Pole
{
	//variables correspondant à chacun des champs de notre table users
	protected  $_id;
	protected  $_libelle;

	//le mapper va nous fournir les méthodes pour interagir avec notre table (objet de type Default_Model_PoleMapper)
	protected $_mapper;
	...
	public function getMapper()
	{
		...
		if(null == $this->_mapper){
			$this->setMapper(new Default_Model_PoleMapper());
		}
