...
class Default_Model_TypeConge
{
	...
	//le mapper va nous fournir les méthodes pour interagir avec notre table (objet de type Default_Model_TypeCongeMapper)
	protected $_mapper;
	...
	public function getMapper()
	{
		...
		if(null == $this->_mapper){
			$this->setMapper(new Default_Model_TypeCongeMapper());
		}
