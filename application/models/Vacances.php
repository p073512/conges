...
class Default_Model_Vacances
{
	...
	//le mapper va nous fournir les méthodes pour interagir avec notre table (objet de type Default_Model_VacancesMapper)
	protected $_mapper;
	...
	public function getMapper()
	{
		...
		if(null == $this->_mapper){
			$this->setMapper(new Default_Model_VacancesMapper());
		}
	...
	{
		return $this->getMapper()->jours_vacances( $debut_mois, $fin_mois);
	}
