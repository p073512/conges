...
$(document).ready(function()
{
  ...
  $('.icon-remove').live('click',function(){
    ...
    url = $(this).attr('id');
     $('#myModal').modal();
     $('.modal-body p').html("Voulez vous r&eacute;ellement supprimer la proposition ?");
		         ...
		         success: function (data,status) {
		             if(data.status == "200")
		            	 ...
		            	 $('html, body').animate({
		                   ...
		                   {
		                	   $("#msgstate").html('<div class="alert alert-info"><button type="button" class="close " data-dismiss="alert"></button><strong>Succes :</strong> Aucune ligne affect�e (v�rifier id proposition)</div>');
		                   }
		                  }
